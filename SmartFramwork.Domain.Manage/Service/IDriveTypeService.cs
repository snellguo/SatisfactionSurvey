...
namespace SmartFramwork.Domain.Manage.Service
{
	...
	/// 用户
	/// </summary>
	public interface IDriveTypeService:IBaseService<DriveTypeEntity>
	{
		/// <summary>
		/// 分页列表
		/// </summary>
		...
		void Create(DriveTypeModel model);

		/// <summary>
		/// 编辑
		/// </summary>
		/// <param name="model">Model</param>
		void Edit(DriveTypeModel model);
		...
		DriveTypeModel GetModelByID(params object[] keyValues);
	}
}
