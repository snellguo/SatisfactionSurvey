...
namespace SmartFramwork.Domain.Manage.Service
{
	...
	/// 用户
	/// </summary>
	public interface IUserExtendService:IBaseService<UserExtendEntity>
	{
		/// <summary>
		/// 分页列表
		/// </summary>
		...
		void Create(UserExtendModel model);

		/// <summary>
		/// 编辑
		/// </summary>
		/// <param name="model">Model</param>
		void Edit(UserExtendModel model);
		...
		UserExtendModel GetModelByID(params object[] keyValues);
	}
}
